...
public class GetVehicleSurveyQuestions extends Getallvehiclesdetails{
	...
	public void getvehiclesurveyquestions() throws org.json.simple.parser.ParseException, ParseException
	{
		 ...
		 JSONObject person = new JSONObject();
			person.put("Registration_Number",registration_number);
...
.body(jsonString)
.post("/api/v1/survey/questions?"+registration_number);
